  ...
  const posts = [
    {
      ...
      imageSrc: "/endingblog1.png", // Correct image path
    },
    {
      id: 2,
      date: "10 February 2022 ",
      title: "Morbi Sodales Tellus Elit In Blandit Risus Suscipit A",
      imageSrc: "/endingblog2.png",
    },
    {
      id: 3,
      date: "10 February 2022 ",
      title: "Curabitur rutrum velit ac congue malesuada",
      imageSrc: "/endingblog3.png",
    },
  ];
  ...
  return (
    <section className="bg-black md:px-[135px] py-[50px]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 flex-grow mt-[59px]">
        {posts.map((post) => (
          <div key={post.id} className="w-full mb-8 border border-white p-4">
            <div className="w-full h-[200px] bg-gray-300 mb-4 flex justify-center items-center text-white text-xl">
              {post.imageSrc ? (
                <Image
                  src={post.imageSrc} // Dynamically set the image source
                  alt={post.title} // Use title for alt text
                  width={500}
                  height={200}

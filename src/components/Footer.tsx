...
const Footer = () => {
  ...
  {/* Post 1 */}
  <li className="flex gap-[16.5px]">
    <Image src="/footer1.png" alt="Food 1" width={60} height={48} />
    <div className="ml-1">
      <h2 
        className="
          text-[16px] 
  ...
  {/* Post 2 */}
  <li className="flex gap-[16.5px]">
    <Image src="/footer2.png" alt="Food" width={60} height={48}/>
    <div className="ml-1">
      <h2 
        className="
          text-[16px] 
  ...
  {/* Post 3 */}
  <li className="flex gap-[16.5px]">
    <Image src="/footer3.png" alt="Food" width={60} height={48}  />
    <div className="ml-1">
      <h2 
        className="
          text-[16px] 
    ...
    decoration-skip-ink-none text-[#FFFFFF]">
        ...
        Copyright @ 2024 by Ismat Fatima. All RightsReserved.
          </span>

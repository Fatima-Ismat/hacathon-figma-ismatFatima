  ...
  return (
    <div>
      ...
      <div className="relative font-[sans-serif] before:absolute before:w-full before:h-full before:inset-0 before:bg-black before:opacity-50 before:z-10">
        <Image
          src="/upper.png" // Correct path for image in public folder
          alt="Banner Image"
        ...
        <div className="container mx-auto flex px-5 py-24">
          <div className="flex flex-col md:flex-row items-center md:space-x-4 mt-2 ml-2">
            <Image
              ...
              alt="hero"
              src="/lemon.png" // Image path from public folder
              width={336}
              height={536}
            />
          </div>
          ...
          <div className="flex flex-col space-y-2 space-x-2 mt-2 ml-2">
            <Image
              className="object-cover object-center w-[309px] h-[271px] mt-[584px] ml-[660px] rounded-[6px]"
              alt="image2"
              src="/yougert.png" // Image path from public folder
              width={309}
              height={271}
            />
            {/* Bottom Image */}
            <Image
              className="object-cover object-center w-[309px] h-[382px] mt-[882px] ml-[660px] rounded-[6px]"
              alt="image3"
              src="/pasta.png" // Image path from public folder
              width={309}
              height={382}
            />
          </div>
      ...
      <section className="text-black body-font">
        <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
          ...
          <Image
            className="mb-10 object-cover object-center w-[1320px] h-[386px] mt-[1552px] ml-[300px]"
            alt="hero"
            src="/thirdSection.png" // Image path from public folder
            width={1320}
            height={386}
          />
        </div>
          ...
          <div className="flex flex-wrap -m-4">
            <div className="p-4 md:w-1/3">
              <div className="h-full rounded-lg overflow-hidden">
                <Image
                  ...
                  src="/student.png" // Image path from public folder
                  width={80}
                  height={80}
                  alt="blog"
                />
            ...
            <div className="p-4 md:w-1/3">
              <div className="h-full  rounded-lg overflow-hidden">
                <Image
                  className="w-[80px] h-[80px] object-contain mx-auto object-center"
                  src="/Coffee.png" // Image path from public folder
                  width={80}
                  height={80}
                  alt="blog"
                />
            ...
            <div className="p-4 md:w-1/3">
              <div className="h-full rounded-lg overflow-hidden">
                <Image
                  className="w-[80px] h-[80px] object-contain mx-auto object-center"
                  src="/person.png" // Image path from public folder
                  width={80}
                  height={80}
                  alt="blog"
                />
